...
export async function PUT(req: Request) {
  try {
    ...
    if (isPartialUpdate) {
      ...
      if (leetcode_handle !== undefined) updateData.leetcode_handle = leetcode_handle || null
      if (codechef_handle !== undefined) updateData.codechef_handle = codechef_handle || null
      if (atcoder_handle !== undefined) updateData.atcoder_handle = atcoder_handle || null
