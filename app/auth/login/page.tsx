...
// Spinner
const Spinner = () => <div className="animate-spin h-5 w-5 border-2 border-white border-t-transparent rounded-full" />
      ...
      <div className="w-full max-w-md">
        <Card className="shadow-xl border border-gray-200 dark:border-gray-700 hover:shadow-2xl transform transition duration-300 max-h-[90vh] overflow-y-auto">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl md:text-3xl font-bold">Login</CardTitle>
            ...
            <div className="flex flex-col gap-3 mb-4">
              <Button
                ...
                className={`flex items-center justify-center gap-2 w-full text-white transition-all duration-300 transform hover:scale-105 ${
                  isOAuthLoading === "google" ? "bg-red-400 cursor-not-allowed" : "bg-red-500 hover:bg-red-600"
                }`}
              >
              ...
              <Button
                ...
                disabled={!!isOAuthLoading}
                className={`flex items-center justify-center gap-2 w-full text-white transition-all duration-300 transform hover:scale-105 ${
                  isOAuthLoading === "github" ? "bg-gray-600 cursor-not-allowed" : "bg-gray-800 hover:bg-gray-900"
                }`}
              >
                {isOAuthLoading === "github" ? <Spinner /> : <Github className="h-5 w-5" />}
