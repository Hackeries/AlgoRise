...
import { Clock, ExternalLink, Trophy, User, CheckCircle, XCircle, AlertCircle, Maximize2 } from "lucide-react"
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-400">Rating: {problem.rating}</div>
                        </div>
                      </div>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <span>{problem?.index}. {problem?.name}</span>
                        </div>
        ...
        <DialogContent className="bg-gray-800 border-gray-700 text-white">
          ...
          <div className="space-y-4">
            <p className="text-gray-300">
              Have you solved this problem? Select the result of your submission:
            </p>
