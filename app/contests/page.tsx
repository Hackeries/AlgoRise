...
export default function ContestsPage() {
  ...
  const createContest = async () => {
    ...
    try {
      ...
      console.log("[v0] Create contest response status:", response.status) // debug
      ...
      if (response.ok) {
        ...
        console.log("[v0] Create contest failure:", data) // debug
        toast({
          title: "Error",
      ...
      console.log("[v0] Create contest exception:", error?.message || error) // debug
      toast({
        title: "Error",
                            ...
                            >
                              {contest.isRegistered
                                ? contest.status === "draft"
                                  ? `Join Now • ${getTimeUntilStart(Math.floor(new Date(contest.starts_at!).getTime() / 1000))}`
                                  : "Join Now"
                                : "Register"}
                            </Button>
                          )}
