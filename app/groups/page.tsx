...
import { Users, Plus, Trophy, Settings, Crown, Shield, User } from "lucide-react"
...
export default function GroupsPage() {
  ...
  async function createFriendsGroup() {
    ...
    try {
      ...
      toast({ title: "Group created", description: `Your friends group "${friendName}" has been created.` })
      setFriendName("")
  ...
  async function leaveGroup(id: string) {
    try {
      ...
      toast({ title: "Error", description: e?.message || "Unable to leave group", variant: "destructive" })
    }
  }
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground mb-6 max-w-md mx-auto">
            Join your college group or create a friends group to start competing and tracking progress together.
          </p>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge variant={membership.group.type === "college" ? "default" : "secondary"}>
