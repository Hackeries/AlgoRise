          ...
          <div className='space-y-6'>
            <div className='text-center'>
              ...
              <h2 className='text-2xl font-bold'>
                Let's make sure it's really you on Codeforces 🚀
              </h2>
              <p className='text-muted-foreground mt-2'>
                Your handle is your passport to the AlgoRise arena
              </p>
            </div>
          ...
          <Card className='border-amber-500/20 bg-card/50 backdrop-blur'>
            <CardHeader className='text-center'>
              ...
              <CardTitle className='text-2xl'>
                Creating Your Adaptive Sheet
              </CardTitle>
              <CardDescription>
                Analyzing your profile to generate personalized problems...
              </CardDescription>
            </CardHeader>
        ...
        {currentStep === 'ready-to-train' && (
          <Card className='border-green-500/20 bg-card/50 backdrop-blur'>
            <CardHeader className='text-center'>
              ...
              <CardDescription>
                Your personalized training is ready. Start with these 3
                problems:
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
                  ...
                  >
                    <div>
                      ...
                      <div className='text-sm text-muted-foreground'>
                        Rating:{' '}
                        {problem.rating || userRating! - 200 + index * 100} •{' '}
