...
import { CFVerificationV2 } from "@/components/auth/cf-verification-v2"
...
export default function OnboardingPage() {
  ...
  const steps = [
    { id: "cf-handle", title: "Link CF Handle", description: "Connect your Codeforces account" },
    { id: "generate-sheet", title: "Generate Sheet", description: "Create your first adaptive sheet" },
    { id: "ready-to-train", title: "Start Training", description: "Begin your journey" },
  ]
  ...
  async function verifyCFHandle() {
    ...
    try {
      ...
      toast({ title: "CF Handle Verified!", description: `Connected ${cfHandle} successfully` })
  ...
  async function generateFirstSheet() {
    ...
    try {
      ...
      toast({ title: "Adaptive Sheet Ready!", description: "Your first 3 problems are waiting" })
  ...
  function completeOnboarding() {
    toast({ title: "Welcome to AlgoRise!", description: "Your training journey begins now" })
    router.push("/train")
  }
        ...
        {currentStep === "cf-handle" && (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold">Let's make sure it's really you on Codeforces 🚀</h2>
              <p className="text-muted-foreground mt-2">Your handle is your passport to the AlgoRise arena</p>
            </div>
            ...
            <CFVerificationV2
              ...
              onVerificationComplete={(data) => {
                ...
                toast({
                  title: "🎉 Connected!",
                  description: `Welcome to AlgoRise, ${data.handle}!`,
                })
