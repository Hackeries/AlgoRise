      ...
      <div className="relative z-10 space-y-8">
        ...
        <section className="py-16 px-4 justify-center">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-4xl font-bold text-[#63EDA1] mb-6 text-center">
              Explore
            </h1>
            ...
            <p className="text-white/80 mb-8">
              Learn complex algorithms visually, then jump straight into a
              curated practice set for that topic.
            </p>
              ...
              <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 relative z-10">
                {VISUALIZERS.map((v) => (
                  <Link
                    ...
                    className="transform-gpu transition-transform duration-200 ease-in-out hover:scale-101"
                  >
