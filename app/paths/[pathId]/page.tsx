...
import { CheckCircle, Circle, Play, BookOpen, Target, Clock } from "lucide-react"
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground text-lg mb-6">{pathData.description}</p>

        {/* Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="text-center p-4 rounded-lg bg-muted/20">
            <div className="text-2xl font-bold text-blue-400">{pathData.progress}%</div>
            <div className="text-sm text-muted-foreground">Complete</div>
          </div>
          <div className="text-center p-4 rounded-lg bg-muted/20">
            <div className="text-2xl font-bold text-green-400">{pathData.totalProblems}</div>
            <div className="text-sm text-muted-foreground">Problems</div>
          </div>
          <div className="text-center p-4 rounded-lg bg-muted/20">
            <div className="text-2xl font-bold text-amber-400">{pathData.estimatedTime}</div>
            <div className="text-sm text-muted-foreground">Duration</div>
          </div>
          <div className="text-center p-4 rounded-lg bg-muted/20">
            <div className="text-2xl font-bold text-purple-400">{pathData.level}</div>
              ...
              <Card key={module.id} className={module.locked ? "opacity-60" : ""}>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant={module.completed ? "default" : module.locked ? "secondary" : "outline"}>
                      {module.completed ? "Complete" : module.locked ? "Locked" : "Available"}
                    </Badge>
                  </div>
                </CardHeader>
                ...
                <CardContent>
                  ...
                  <Button disabled={module.locked} className="w-full" asChild={!module.locked}>
                    {module.locked ? (
