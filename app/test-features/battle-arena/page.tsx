...
export default function BattleArenaTestPage() {
  ...
  const runTest = async (testName: string, testFn: () => Promise<boolean>) => {
    try {
      ...
      toast({
        title: "Test Error",
        description: `${testName} encountered an error: ${error instanceof Error ? error.message : "Unknown error"}`,
        variant: "destructive"
      });
    }
  };
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Test the UI components manually
            </CardDescription>
          </CardHeader>
            ...
            <div>
              ...
              {dbTestResult && (
                <p className="text-sm mt-2">
                  Result: <span className={dbTestResult.includes("Error") ? "text-red-500" : "text-green-500"}>
                    {dbTestResult}
                  </span>
                </p>
              )}
