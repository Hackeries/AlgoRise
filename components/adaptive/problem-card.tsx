...
function getRatingColor(rating: number) {
  if (rating >= 2300) return 'from-red-500 to-red-600';
...
function getRatingTextColor(rating: number) {
  if (rating >= 2300) return 'text-red-600';
        ...
        <CardContent className="space-y-4 relative">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="flex-1">
              <Button
                className={`w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all duration-200 ${
