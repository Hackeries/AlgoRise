...
export default function CFVerificationDialog({ open, onOpenChange }: CFVerificationDialogProps) {
  ...
  useEffect(() => {
    if (open) {
      router.replace("/profile?verify=cf")
    }
  }, [open, router])
        ...
        {open && (
          <div className="space-y-6">
            <div className="text-center">
              <h3 className="text-lg font-semibold text-white mb-2">Verification Moved</h3>
              <p className="text-slate-300 text-sm">Codeforces verification is now done only on your Profile page.</p>
            </div>
            <Button asChild className="w-full">
              <Link href="/profile?verify=cf">Go to Profile</Link>
            </Button>
          </div>
        )}
        {!open && (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-white mb-2">OAuth Verification (Recommended)</h3>
                  <p className="text-slate-300 text-sm mb-4">
                    Quick and secure verification using Codeforces' official OAuth system. No challenges required - just
                    log in with your Codeforces account.
                  </p>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-300 text-sm mb-4">
                    Traditional verification method using a contest submission challenge. Requires solving a problem
                    within a time limit.
                  </p>
                  <div className="flex flex-wrap gap-2">
          ...
          <div className="space-y-6">
            ...
            <Alert className="bg-blue-900/30 border-blue-700">
              ...
              <AlertDescription className="text-blue-200">
                <strong>Requirements:</strong> Your account must have participated in at least 3 contests and not be
