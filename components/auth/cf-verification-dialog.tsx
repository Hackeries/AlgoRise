...
export default function CFVerificationDialog({ open, onOpenChange, onSuccess }: CFVerificationDialogProps) {
  ...
  const handleOAuthVerification = async () => {
    ...
    try {
      ...
      const eligibilityResponse = await fetch(`/api/cf/eligibility?handle=${encodeURIComponent(handle.trim())}`)
      ...
      if (!eligibilityData.eligible) {
        setError(`Insufficient contest participation. This account has participated in ${eligibilityData.contestCount} contests. At least 3 contest participations are required for verification.`)
        return
      }
      ...
      setError(error instanceof Error ? error.message : 'Failed to start OAuth verification')
    } finally {
      setLoading(false)
    }
  }
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-300 text-sm mb-4">
                    Quick and secure verification using Codeforces' official OAuth system.
                    No challenges required - just log in with your Codeforces account.
                  </p>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-300 text-sm mb-4">
                    Traditional verification method using a contest submission challenge.
                    Requires solving a problem within a time limit.
                  </p>
                  <div className="flex flex-wrap gap-2">
        ...
        {step === 'oauth' && (
          <div className="space-y-6">
            <div className="text-center">
              <h3 className="text-lg font-semibold text-white mb-2">OAuth Verification</h3>
              <p className="text-slate-300 text-sm">
                Enter your Codeforces handle to validate eligibility for OAuth verification:
              </p>
            </div>
            ...
            <Alert className="bg-blue-900/30 border-blue-700">
              ...
              <AlertDescription className="text-blue-200">
                <strong>Requirements:</strong> Your account must have participated in at least 3 contests and not be connected to another account.
              </AlertDescription>
            </Alert>

            <div className="space-y-4">
              <div>
                <Label htmlFor="cf-handle" className="text-white">Codeforces Handle</Label>
                <Input
                  id="cf-handle"
        ...
        {step === 'manual' && (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-slate-300 text-sm">
                Enter your Codeforces handle to start the manual verification process:
              </p>
            </div>

            <div className="space-y-4">
              <div>
                <Label htmlFor="cf-handle-manual" className="text-white">Codeforces Handle</Label>
                <Input
                  id="cf-handle-manual"
