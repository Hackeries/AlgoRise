...
export default function CFVerificationTrigger({
  ...
  if (compact && !isVerified) {
    return (
      <Button asChild variant="outline" className="w-full border-blue-600 text-blue-400 hover:bg-blue-600/20">
        <Link href="/profile?verify=cf">Verify on Profile</Link>
      </Button>
    )
  }
          ...
          {showTitle && (
            <>
              ...
              <CardDescription className="text-slate-300">
                Verify your Codeforces account on your Profile page
              </CardDescription>
            </>
          )}
        </CardHeader>
          ...
          <div className="space-y-4">
            <div className="text-sm text-slate-300">
              ...
              <ul className="mt-2 space-y-1 list-disc list-inside">
                <li>Adaptive practice based on your rating</li>
                <li>Progress tracking and analytics</li>
                <li>Contest reminders and history</li>
                <li>Leaderboards</li>
              </ul>
            </div>

            <Button asChild className="w-full bg-blue-600 hover:bg-blue-700">
              <Link href="/profile?verify=cf">
