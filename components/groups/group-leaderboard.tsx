...
export function GroupLeaderboard({ groupId, groupName, timeRange = 'all' }: GroupLeaderboardProps) {
  ...
  }>(`/api/groups/${groupId}/leaderboard?range=${timeRange}&sort=${sortBy}`, fetcher)
                ...
                {data.leaderboard.map((entry) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      {sortBy === 'problems' && (
                        <div>
                          <p className="text-sm font-semibold">{entry.problemsSolved}</p>
        ...
        {data?.stats && (
          <div className="mt-6 pt-6 border-t">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <p className="text-2xl font-bold">{Math.round(data.stats.avgRating)}</p>
