...
export function FilterBar({
  ...
  const { data: companiesResp } = useSWR<{ companies: Company[] }>("/api/companies", fetcher)
      ...
      <Card className="border bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="p-4 grid grid-cols-1 md:grid-cols-5 gap-3">
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-3 md:col-span-3">
            <Select
              value={value.topic}
              onValueChange={(v) => onChange({ ...value, topic: (v || undefined) as Filters["topic"] })}
            >
              <SelectTrigger>
            ...
            <Select
              ...
              onValueChange={(v) =>
                onChange({ ...value, difficulty: (v || undefined) as Filters["difficulty"] })
              }
            >
              <SelectTrigger>
            ...
            <Select
              ...
              onValueChange={(v) =>
                onChange({ ...value, platform: (v || undefined) as Filters["platform"] })
              }
            >
              <SelectTrigger>
            ...
            <Select
              ...
              onValueChange={(v) => onChange({ ...value, companyId: v || undefined })}
            >
              <SelectTrigger>
            ...
            <div className="flex items-center gap-2">
              <Button className="w-full" onClick={() => onChange({ ...value, query: q })}>
                Apply
              </Button>
              <Button
                type="button"
