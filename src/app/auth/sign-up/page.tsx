...
import { Mail, Lock, Eye, EyeOff, Github, Loader2, ArrowRight, Code2, Check } from 'lucide-react'
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary/5 items-center justify-center p-12">
        <div className="max-w-md">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Join thousands of programmers improving their skills with personalized practice.
          </p>
